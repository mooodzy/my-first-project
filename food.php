...
<div class="container">
    <img src="food.png" width="180" height="131" class="auto-style3">
    <h1>Camel Food Store</h1>
    <div class="products">
        <div class="product">
            
            <p><img src="grain.jpg" width="55px" height="50px"></p>
            <h2>Mixed Grain 30KG</h2>
           <p><?php echo number_format(5.000, 3); ?> OMR</p>
            <form action="" method="post">
                <input type="hidden" name="productID">
                <input type="hidden" name="productName" value="Mixed Grain 30KG">
        ...
        <div class="product">
            <p><img src="date.jpg" width="55px" height="50px"></p>
            <h2>Dates for animals 50KG</h2>
            <p><?php echo number_format(20.444, 3); ?> OMR</p>
            <form action="" method="post">
                <input type="hidden" name="productID">
                <input type="hidden" name="productName" value="Dates for animals 50KG">
                <input type="hidden" name="price" value="20.444">
                <input type="submit" value="Add to basket" name="submit2">
            </form>
        </div>

        <div class="product">
            <p><img src="grass.jpg" width="55px" height="50px"></p>
            <h2>Grass for animals 4KG</h2>
            <p><?php echo number_format(2.000, 3); ?> OMR</p>
            <form action="" method="post">
                <input type="hidden" name="productID">
                <input type="hidden" name="productName" value="Grass for animals 4KG">
